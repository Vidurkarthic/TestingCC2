...
public class AppTest 
{
    ...
    public void setup() {
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter(
                "C:\\Users\\9176601\\Desktop\\it sckcet\\softwareTesting-1\\ExtentReports\\exercise1\\report.html");
        reports.attachReporter(spark);
        test = reports.createTest("Demo Result");
        WebDriverManager.chromedriver().setup();
        driver = new ChromeDriver();
        PropertyConfigurator.configure("C:\\Users\\44491701\\Desktop\\cc2softwaretesting\\src\\test\\java\\com\\resources\\log4j.properties");
    }
    @BeforeMethod
    ...
    public void testCase1() throws IOException, InterruptedException {
        ...
        FileInputStream fs = new FileInputStream("C:\\Users\\6591701\\Downloads\\input for websites.xlsx");
